        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
            <div class="card border-light mb-3">
                <div class="card-body text-dark">
                   <center> 
                   <img src="/imagenes/top.png" class="img-fluid" alt="..." width="150px">
...
<img src="/imagenes/producto.jpg" class="card-img-top" alt="...">
    ...
    <div>
        <center> 
        <div class="btn-group" role="group" aria-label="Basic example">
            <button  type="button" class="btn btn-dark">Ver</i></button>
            <button  type="button" class="btn btn-dark">Comprar</i></button>
        </div>
        </center>
    </div>
</div>
...
<ul class="nav justify-content-top  ">
    ...
    <li class="nav-item">
        <a class="nav-link disabled" aria-current="page" href="#">Disabled</a>
    </li>
</ul>
<div>
